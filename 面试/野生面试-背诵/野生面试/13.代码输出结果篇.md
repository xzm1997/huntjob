...
### 1. 代码输出结果 :face_with_head_bandage: :red_circle: :red_circle: :green_book:
...
### 2. 代码输出结果:face_with_head_bandage: :red_circle: :red_circle: :green_book:
...
### 4. 代码输出结果:face_with_head_bandage: :red_circle: :green_book:
...
### 6. 代码输出结果:face_with_head_bandage: :red_circle: :red_circle: :green_book:
...
### 8. 代码输出结果  :green_book: :green_book:
...
### 9. 代码输出结果:face_with_head_bandage: :red_circle: :red_circle:
...
### 10. 代码输出结果:face_with_head_bandage: :red_circle: :red_circle:
...
### 13. 代码输出结果:face_with_head_bandage: :red_circle: :green_book:
...
### 14. 代码输出结果:face_with_head_bandage: :red_circle: :green_book:
...
### 15. 代码输出结果 :face_with_head_bandage: :red_circle: :red_circle:
...
<a src="https://www.bookstack.cn/read/es6-3rd/spilt.6.docs-promise.md">参考</a>
...
### 16. 代码输出结果:face_with_head_bandage: :red_circle: :green_book:
...
### 18. 代码输出结果:face_with_head_bandage: :red_circle: :green_book:
...
### 19. 代码输出结果:green_book: :red_circle: :green_book:
...
### 20. 代码输出结果:face_with_head_bandage: :red_circle: :red_circle:
...
### 22. 代码输出结果:cry: :red_circle: :red_circle:
...
### 23. 代码输出结果:cry: :red_circle: :red_circle:
...
### 25. 代码输出结果:cry: :red_circle: :green_book:
...
### 26. 代码输出结果:red_circle: :red_circle: :red_circle:
...
### 27. 代码输出结果 :red_circle: :red_circle: :green_book:
...
在JavaScript中，this指向函数执行时的当前对象。在执行`foo`的时候，执行环境就是`doFoo`函数，执行环境为全局。所以，`foo`中的`this`是指向window的，所以会打印出2。
...
### 6. 代码输出结果:red_circle: :red_circle: :red_circle: :green_book:
...
### 7. 代码输出结果:red_circle: :red_circle: :red_circle: :red_circle:
...
### 8. 代码输出问题:red_circle: :green_book: :red_circle:
...
### 9. 代码输出结果:red_circle: :red_circle: :red_circle:
...
### 10. 代码输出结果 :red_circle: :red_circle: :red_circle:
...
### 12. 代码输出结果 :red_circle: :red_circle:
...
### 13. 代码输出结果 :red_circle: :red_circle:
...
### 3. 代码输出结果 :red_circle: :red_circle: :green_book:
...
### 7.  代码输出问题 :red_circle: :red_circle:
